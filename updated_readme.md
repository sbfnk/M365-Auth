...
`demo.py` (not shown here) is a small example script that reuses the same tokens to access your mailbox.
...
This is meant as a simple, readable example; for real‑world use you will typically rely on offlineimap3 and an SMTP client like msmtp.
